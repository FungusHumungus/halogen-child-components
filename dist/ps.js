...
(function($PS) {
  ...
  var Halogen_Query_HalogenM = $PS["Halogen.Query.HalogenM"];                
  var Post = (function () {
      function Post(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Post.create = function (value0) {
          return function (value1) {
              return new Post(value0, value1);
          };
      };
      return Post;
  })();
  ...
  var CountMessages = (function () {
      function CountMessages(value0) {
          this.value0 = value0;
      };
      CountMessages.create = function (value0) {
          return new CountMessages(value0);
      };
      return CountMessages;
  })();
  var SendMessage = (function () {
      function SendMessage(value0) {
          this.value0 = value0;
      };
      SendMessage.create = function (value0) {
          return new SendMessage(value0);
      };
      return SendMessage;
  })();
  ...
  var SubmitMessage = (function () {
      ...
      SubmitMessage.value = new SubmitMessage();
      return SubmitMessage;
  })();
  var render = function (v) {
      var renderReceived = function (v1) {
          return Halogen_HTML_Elements.li_([ Halogen_HTML_Core.text("From" + (Data_Show.show(Data_Show.showInt)(v1.value1) + (" : " + v1.value0))) ]);
      };
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(v.message), Halogen_HTML_Events.onValueChange(function ($33) {
          return Data_Maybe.Just.create(UpdateMessage.create($33));
      }) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(SubmitMessage.value))) ])([ Halogen_HTML_Core.text("Send") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(renderReceived)(v.received)), Halogen_HTML_Elements.hr_ ]);
  };
  ...
  var handleQuery = function (v) {
      if (v instanceof ReceiveMessage) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
              ...
              $20.received = Data_Array.snoc(st.received)(v.value0);
              return $20;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(new Data_Maybe.Just(v.value1));
          });
      };
      if (v instanceof CountMessages) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Array.length)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.received;
          })))(function (v1) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.Just.create(v.value0(v1)));
          });
      };
      throw new Error("Failed pattern match at Child (line 65, column 1 - line 65, column 86): " + [ v.constructor.name ]);
  };
  var handleAction = function (v) {
      if (v instanceof UpdateMessage) {
      ...
      if (v instanceof SubmitMessage) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(new UpdateMessage("")))(function () {
                  return Halogen_Query_HalogenM.raise(SendMessage.create(new Post(v1.message, v1.id)));
              });
          });
      };
      throw new Error("Failed pattern match at Child (line 55, column 1 - line 55, column 78): " + [ v.constructor.name ]);
  };
  var control = Halogen_Component.mkComponent({
...
(function($PS) {
  ...
  var handleAction = function (v) {
      var send = function (id$prime) {
          if (id$prime === v.value0.value0.value1) {
          ...
          if (Data_Boolean.otherwise) {
              return Halogen_Query_HalogenM.query()(new Data_Symbol.IsSymbol(function () {
                  return "child";
              }))(Data_Ord.ordInt)(_child)(id$prime)(Halogen_Query.tell(Child.ReceiveMessage.create(v.value0.value0)));
          };
          throw new Error("Failed pattern match at Parent (line 38, column 7 - line 42, column 48): " + [ id$prime.constructor.name ]);
      };
      return Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Foldable.foldableArray)(send)(Data_Array.range(1)(3));
  };
  var render = function (v) {
      var renderSlot = function (id) {
          return Halogen_HTML.slot()(new Data_Symbol.IsSymbol(function () {
              return "child";
          }))(Data_Ord.ordInt)(_child)(id)(Child.control)({
              id: id
          })(function ($9) {
              return Data_Maybe.Just.create(ReceiveMessage.create($9));
          });
      };
      return Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(renderSlot)(Data_Array.range(1)(3)));
  };
...
(function($PS) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Parent.page)(Data_Unit.unit)));
  exports["main"] = main;
})(PS);
PS["Main"].main();